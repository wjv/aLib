...
data_folder = illuminareaddir.rstrip('/')+'/'
old_set = set()
miseq_notified = set()
...
#          <p>Please fill out an analysis request for this run before the run finishes using the internal form available <a href="http://biofs05/~sbsuser/webform/form.php">here</a>. 
